    ...
    'things-to-do': {
      ...
      sections: [
        ...
        },
        {
          ...
          body: 'Zurich provides a range of interesting museums.',
          items: ['Kunsthaus Zürich houses art from the Middle Ages to contemporary work, with Swiss painters, Impressionism, Classical Modernism, Dada, Giacometti, and Munch among the highlights.', 'Museum Rietberg focuses on arts and cultures from Asia, Africa, the Americas, and Oceania.', 'Lindt Home of Chocolate in Kilchberg is interactive and especially fun with children; take the S8 to Kilchberg and check the exact connection in SBB Mobile.', 'Landesmuseum Zürich focuses on Swiss history and culture.'],
          links: [
            ...
            { label: 'Landesmuseum Zürich', href: 'https://www.landesmuseum.ch/en' },
          ],
        ...
        },
        {
          ...
          body: 'Warm days are well suited to time by the water. The official bathing areas are known as "badis". Note that the river Limmat has a strong current and that the shore can be crowded on weekends.',
          items: ['For river swimming, Oberer Letten or Unterer Letten are bathing spots suitable for confident swimmers only, not for children.', 'For lake swimming, consider the Badis Tiefenbrunnen, Mythenquai, Utoquai and Enge.', 'The official websites provide information on opening hours, rules, and water conditions.', 'A Lake Zurich boat excursion is a relaxed way to see the lake and shoreline.'],
          links: [
        ...
        {
          title: 'Day trips',
          body: 'These are practical day trips from Zurich if you would like a longer excursion without changing accommodation.',
          items: ['Lucerne, ideally with a boat on Lake Lucerne.', 'Rapperswil, reachable by train or a longer lake boat route, for the castle, rose garden, old town, wooden bridge, and children’s zoo.', 'Rheinfall near Schaffhausen, the largest waterfall in Europe by volume.', 'Alpstein is a highly recommended, scenic mountain area, with hikes to Seealpsee, Hoher Kasten, Saxerlücke and Säntis, with routes at different difficulty levels.', 'Grosser Mythen for moderate hikes and scenic views.', 'Pizol Five-Lakes Hike.', 'Einsiedeln for its monastery church with a richly decorated baroque interior and nearby walking options.', 'Bern for its quaint old town, or Basel for beautiful art museums including Fondation Beyeler and Kunstmuseum Basel.'],
          links: [
            ...
            { label: 'SchweizMobil hiking', href: 'https://schweizmobil.ch/en/hiking-in-switzerland' },
        ...
        },
        {
          ...
          items: ['Lauterbrunnen and Jungfraujoch for breathtaking high-Alpine scenery.', 'Zermatt for unforgettable views of the Matterhorn; more economical accommodation can often be found in nearby Täsch.', 'Hiking ideas: Aletsch Glacier viewpoints, the Bernese Oberland, Engadin, and Valais.', 'Swiss National Park in Graubünden.'],
          links: [
            { label: 'Swiss National Park', href: 'https://www.nationalpark.ch/en/' },
            { label: 'Jungfraujoch', href: 'https://www.jungfrau.ch/en/tourism/' },
            { label: 'Zermatt', href: 'https://zermatt.swiss/en' },
            { label: 'Aletsch Arena hiking', href: 'https://www.aletscharena.ch/en/activities/hiking' },
            { label: 'SchweizMobil hiking', href: 'https://schweizmobil.ch/en/hiking-in-switzerland' },
          ],
      ...
      sections: [
        {
          ...
          body: 'Zurich is easy to navigate by tram, train, bus, boat, and on foot. Public transport is recommended; driving is inconvenient due to limited parking.',
          items: [
            'Download SBB Mobile for Swiss-wide timetables, live platforms, and tickets; use ZVV for Zurich-area local tickets.',
            'ZVV tickets are zone-based. Zurich city is zone 110, Küsnacht ZH zone 140, and Richterswil zone 153; apps usually assign zones automatically.',
            'For central Zurich, a ZVV single or 24h ticket is usually easiest. For Küsnacht ZH or Richterswil, enter the destination and buy the suggested zones.',
            'For trips beyond Zurich, compare point-to-point tickets, Supersaver tickets, and Saver Day Passes. Supersaver tickets are cheaper but train-specific.',
            'For several longer journeys, lake trips, or mountain excursions, compare the Swiss Half Fare Card. In 2026 it costs CHF 150 for one month and gives up to 50% off many journeys.',
            'Children under 6 travel free in the Zurich network; ages 6-15 pay reduced fares. For longer trips, check SBB child tickets or the Junior Travelcard.',
            'For relaxed city exploring, rent a bike if the weather and traffic conditions suit you.',
          ],
          gallery: [
        ...
        },
        {
          ...
          items: ['Migros and Coop are the largest supermarket chains and are useful for breakfasts, snacks, picnic supplies, and children’s basics.', 'Taxis are usually expensive. Use them only when luggage, children, or accessibility needs make them genuinely useful.', 'Low-cost options include lake walks, Old Town wandering, hikes, parks, supermarket picnics, choosing accommodation near a tram, train, or bus stop, and buying Supersaver tickets where applicable.'],
          image: '/images/places/zurich-lindenhof-view.jpg',
          imageAlt: 'Zurich old town and the Limmat from Lindenhof',
          exchangeRates: true,
        },
        ...
        },
        {
          ...
          body: 'Guests can get in touch with Manfredi and family for practical advice, especially around hikes, family-friendly plans and longer trips.',
...
applyLocalizedCopy('it', {
  ...
  'things-to-do': {
    ...
    sections: [
      ...
      {
        title: 'Lago e acqua',
        body: 'Le giornate calde si prestano bene al lago e ai bagni pubblici, chiamati "badis". Tenete presente che la Limmat ha una corrente forte e che le rive possono essere affollate nei fine settimana.',
        items: ['Per nuotare nel fiume, Oberer Letten o Unterer Letten sono badis adatte solo a nuotatori sicuri, non ai bambini.', 'Per il lago, considerate le badis Tiefenbrunnen, Mythenquai, Utoquai ed Enge.', 'I siti ufficiali indicano orari, regole e condizioni dell’acqua.', 'Un giro in battello sul Lago di Zurigo è un modo tranquillo per vedere il lago e la riva.'],
        links: [
          { label: 'Oberer Letten', href: 'https://www.stadt-zuerich.ch/de/stadtleben/sport-und-erholung/sport-und-badeanlagen/sommerbaeder/oberer-letten.html' },
          { label: 'Badis di Zurigo', href: 'https://www.stadt-zuerich.ch/de/stadtleben/sport-und-erholung/sport-und-badeanlagen.html' },
          { label: 'Battelli sul Lago di Zurigo', href: 'https://www.zsg.ch/en/' },
        ],
        imageAlt: 'Una barca sul Lago di Zurigo vicino all’Hotel Sonne',
      },
      {
        title: 'Gite in giornata',
        body: 'Queste gite sono pratiche da Zurigo se volete fare un’escursione più lunga senza cambiare alloggio.',
        items: ['Lucerna, idealmente con un giro in battello sul Lago dei Quattro Cantoni.', 'Rapperswil, raggiungibile in treno o con un giro più lungo in battello, per castello, roseto, centro storico, ponte di legno e zoo per bambini.', 'Rheinfall vicino a Sciaffusa, la cascata più grande d’Europa per volume d’acqua.', 'L’Alpstein è una zona di montagna molto consigliata e panoramica, con escursioni verso Seealpsee, Hoher Kasten, Saxerlücke e Säntis, e percorsi di diversa difficoltà.', 'Grosser Mythen per escursioni moderate e viste panoramiche.', 'Pizol Five-Lakes Hike.', 'Einsiedeln per la chiesa del monastero con interni barocchi riccamente decorati e possibilità di passeggiate nei dintorni.', 'Berna per il centro storico caratteristico, o Basilea per bei musei d’arte come Fondation Beyeler e Kunstmuseum Basel.'],
        links: [
          { label: 'Battelli sul Lago dei Quattro Cantoni', href: 'https://www.luzern.com/en/the-region/excursions/by-boat' },
          { label: 'Rapperswil', href: 'https://www.zuerich.com/en/visit/attractions/rapperswil' },
          { label: 'Rheinfall', href: 'https://rheinfall.ch/en/' },
          { label: 'Abbazia di Einsiedeln', href: 'https://www.kloster-einsiedeln.ch/' },
          { label: 'Escursioni nell’Alpstein', href: 'https://www.appenzell.ch/en/summer/hiking.html' },
          { label: 'Pizol Five-Lakes Hike', href: 'https://pizol.com/en/hiking-trails/5-lakes-hiking/' },
          { label: 'Escursionismo SchweizMobil', href: 'https://schweizmobil.ch/en/hiking-in-switzerland' },
          { label: 'Fondation Beyeler', href: 'https://www.fondationbeyeler.ch/en/' },
        ],
        imageAlt: 'Un lago di montagna in Svizzera',
      },
      {
        ...
        items: ['Lauterbrunnen e Jungfraujoch per paesaggi alpini spettacolari.', 'Zermatt per viste indimenticabili sul Cervino; alloggi più economici si trovano spesso nella vicina Täsch.', 'Idee per escursioni: punti panoramici sull’Aletsch Glacier, Oberland bernese, Engadina e Vallese.', 'Parco Nazionale Svizzero nei Grigioni.'],
        links: [
          { label: 'Parco Nazionale Svizzero', href: 'https://www.nationalpark.ch/en/' },
          { label: 'Jungfraujoch', href: 'https://www.jungfrau.ch/en/tourism/' },
          { label: 'Zermatt', href: 'https://zermatt.swiss/en' },
          { label: 'Escursioni Aletsch Arena', href: 'https://www.aletscharena.ch/en/activities/hiking' },
          { label: 'Escursionismo SchweizMobil', href: 'https://schweizmobil.ch/en/hiking-in-switzerland' },
        ],
    ...
    sections: [
      {
        ...
        body:
          'A Zurigo ci si muove facilmente con tram, treni, autobus, battelli e a piedi. Consigliamo i mezzi pubblici; guidare è scomodo per via dei parcheggi limitati.',
        items: [
          'Scaricate SBB Mobile per orari in tutta la Svizzera, binari in tempo reale e biglietti; usate ZVV per i biglietti locali dell’area di Zurigo.',
          'I biglietti ZVV sono basati sulle zone. La città di Zurigo è la zona 110, Küsnacht ZH la zona 140 e Richterswil la zona 153; di solito le app assegnano automaticamente le zone.',
          'Per il centro di Zurigo, di solito è più semplice un biglietto singolo ZVV o un biglietto 24 ore. Per Küsnacht ZH o Richterswil, inserite la destinazione e comprate le zone suggerite.',
          'Per viaggi fuori Zurigo, confrontate biglietti punto-punto, Supersaver tickets e Saver Day Passes. I Supersaver possono essere più economici, ma sono validi solo su un treno specifico.',
          'Per diversi viaggi più lunghi, gite sul lago o escursioni in montagna, confrontate la Swiss Half Fare Card. Nel 2026 costa CHF 150 per un mese e offre fino al 50% di sconto su molti viaggi.',
          'I bambini sotto i 6 anni viaggiano gratis nella rete di Zurigo; dai 6 ai 15 anni pagano tariffe ridotte. Per viaggi più lunghi, controllate i biglietti bambini SBB o la Junior Travelcard.',
          'Per esplorare la città con calma, noleggiate una bici se meteo e traffico sono adatti.',
        ],
        gallery: [
      ...
      },
      {
        ...
        items: ['Migros e Coop sono le principali catene di supermercati e sono utili per colazioni, snack, picnic e necessità per bambini.', 'I taxi sono di solito costosi. Usateli solo quando bagagli, bambini o esigenze di accessibilità li rendono davvero utili.', 'Opzioni economiche includono passeggiate sul lago, centro storico, escursioni, parchi, picnic con prodotti del supermercato, alloggi vicino a tram, treno o autobus e Supersaver tickets quando disponibili.'],
        image: '/images/places/zurich-lindenhof-view.jpg',
        imageAlt: 'Centro storico di Zurigo e la Limmat dal Lindenhof',
        exchangeRates: true,
      },
      ...
      },
      {
        ...
        body:
          'Gli ospiti possono contattare Manfredi e la famiglia per consigli pratici, soprattutto su escursioni, programmi con bambini e viaggi più lunghi.',
  ...
  'things-to-do': {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Zürich bietet mehrere interessante Museen.',
        items: ['Das Kunsthaus Zürich zeigt Kunst vom Mittelalter bis zur Gegenwart, mit Schweizer Malerei, Impressionismus, Klassischer Moderne, Dada, Giacometti und Munch als Schwerpunkten.', 'Das Museum Rietberg widmet sich Kunst und Kulturen aus Asien, Afrika, Amerika und Ozeanien.', 'Lindt Home of Chocolate in Kilchberg ist interaktiv und besonders auch mit Kindern geeignet; nehmt die S8 nach Kilchberg und prüft die genaue Verbindung in SBB Mobile.', 'Das Landesmuseum Zürich widmet sich der Schweizer Geschichte und Kultur.'],
        links: [
          { label: 'Kunsthaus', href: 'https://www.kunsthaus.ch/en/sammlung/' },
          { label: 'Museum Rietberg', href: 'https://www.zuerich.com/en/visit/culture/museum-rietberg' },
          { label: 'Lindt', href: 'https://www.lindt-home-of-chocolate.com/en/' },
      ...
      },
      {
        ...
        body: 'Warme Tage eignen sich gut für Zeit am Wasser. Die offiziellen Badeanlagen werden "Badis" genannt. Beachtet, dass die Limmat eine starke Strömung hat und die Ufer am Wochenende voll sein können.',
        items: ['Zum Flussschwimmen sind Oberer Letten oder Unterer Letten Badis nur für sichere Schwimmerinnen und Schwimmer, nicht für Kinder.', 'Für den See kommen die Badis Tiefenbrunnen, Mythenquai, Utoquai und Enge infrage.', 'Die offiziellen Websites informieren über Öffnungszeiten, Regeln und Wasserbedingungen.', 'Eine Zürichsee-Bootsfahrt ist eine ruhige Möglichkeit, See und Ufer zu sehen.'],
        links: [
          { label: 'Oberer Letten', href: 'https://www.stadt-zuerich.ch/de/stadtleben/sport-und-erholung/sport-und-badeanlagen/sommerbaeder/oberer-letten.html' },
          { label: 'Zürcher Badis', href: 'https://www.stadt-zuerich.ch/de/stadtleben/sport-und-erholung/sport-und-badeanlagen.html' },
          { label: 'Zürichsee-Schiffe', href: 'https://www.zsg.ch/en/' },
        ],
        imageAlt: 'Ein Boot auf dem Zürichsee nahe beim Hotel Sonne',
      },
      {
        ...
        items: ['Luzern, idealerweise mit einer Bootsfahrt auf dem Vierwaldstättersee.', 'Rapperswil, per Zug oder längerer Seefahrt erreichbar, mit Schloss, Rosengarten, Altstadt, Holzbrücke und Kinderzoo.', 'Rheinfall bei Schaffhausen, der wasserreichste Wasserfall Europas.', 'Der Alpstein ist ein sehr empfehlenswertes und landschaftlich schönes Berggebiet, mit Wanderungen zum Seealpsee, Hoher Kasten, zur Saxerlücke und zum Säntis sowie Routen verschiedener Schwierigkeitsgrade.', 'Grosser Mythen für mittelschwere Wanderungen und schöne Aussichten.', 'Pizol Five-Lakes Hike.', 'Einsiedeln mit der Klosterkirche und ihrem reich ausgestatteten barocken Innenraum sowie Spaziermöglichkeiten in der Umgebung.', 'Bern für die schöne Altstadt oder Basel für Kunstmuseen wie Fondation Beyeler und Kunstmuseum Basel.'],
        links: [
          { label: 'Vierwaldstättersee-Schiffe', href: 'https://www.luzern.com/en/the-region/excursions/by-boat' },
          { label: 'Rapperswil', href: 'https://www.zuerich.com/en/visit/attractions/rapperswil' },
          { label: 'Rheinfall', href: 'https://rheinfall.ch/en/' },
          { label: 'Kloster Einsiedeln', href: 'https://www.kloster-einsiedeln.ch/' },
          { label: 'Alpstein-Wanderungen', href: 'https://www.appenzell.ch/en/summer/hiking.html' },
          { label: 'Pizol Five-Lakes Hike', href: 'https://pizol.com/en/hiking-trails/5-lakes-hiking/' },
          { label: 'SchweizMobil Wandern', href: 'https://schweizmobil.ch/en/hiking-in-switzerland' },
          { label: 'Fondation Beyeler', href: 'https://www.fondationbeyeler.ch/en/' },
        ],
        imageAlt: 'Ein Bergsee in der Schweiz',
      },
      {
        ...
        items: ['Lauterbrunnen und Jungfraujoch für eindrucksvolle Hochalpenlandschaft.', 'Zermatt für unvergessliche Blicke auf das Matterhorn; günstigere Unterkünfte findet man oft im nahe gelegenen Täsch.', 'Wanderideen: Aussichtspunkte am Aletschgletscher, Berner Oberland, Engadin und Wallis.', 'Schweizerischer Nationalpark in Graubünden.'],
        links: [
          { label: 'Schweizerischer Nationalpark', href: 'https://www.nationalpark.ch/en/' },
          { label: 'Jungfraujoch', href: 'https://www.jungfrau.ch/en/tourism/' },
          { label: 'Zermatt', href: 'https://zermatt.swiss/en' },
          { label: 'Aletsch Arena Wandern', href: 'https://www.aletscharena.ch/en/activities/hiking' },
          { label: 'SchweizMobil Wandern', href: 'https://schweizmobil.ch/en/hiking-in-switzerland' },
        ],
    ...
    sections: [
      {
        ...
        body:
          'In Zürich bewegt ihr euch gut mit Tram, Zug, Bus, Schiff und zu Fuss. Wir empfehlen den öffentlichen Verkehr; Autofahren ist wegen begrenzter Parkplätze unpraktisch.',
        items: [
          'Ladet SBB Mobile für Fahrpläne in der ganzen Schweiz, aktuelle Gleisangaben und Tickets herunter; nutzt ZVV für lokale Tickets im Raum Zürich.',
          'ZVV-Tickets sind zonenbasiert. Zürich Stadt ist Zone 110, Küsnacht ZH Zone 140 und Richterswil Zone 153; die Apps weisen die Zonen meistens automatisch zu.',
          'Für Zürich Zentrum ist meistens ein ZVV-Einzelticket oder ein 24h-Ticket am einfachsten. Für Küsnacht ZH oder Richterswil gebt das Ziel ein und kauft die vorgeschlagenen Zonen.',
          'Für Fahrten ausserhalb Zürichs vergleicht Punkt-zu-Punkt-Tickets, Supersaver Tickets und Saver Day Passes. Supersaver Tickets sind günstiger, aber zuggebunden.',
          'Für mehrere längere Reisen, Seefahrten oder Bergausflüge vergleicht die Swiss Half Fare Card. 2026 kostet sie CHF 150 für einen Monat und gibt bis zu 50% Rabatt auf viele Fahrten.',
          'Kinder unter 6 Jahren fahren im Zürcher Verkehrsverbund kostenlos; Kinder von 6 bis 15 Jahren zahlen reduzierte Tarife. Für längere Reisen prüft SBB-Kindertickets oder die Junior Travelcard.',
          'Für entspanntes Erkunden der Stadt könnt ihr ein Velo mieten, wenn Wetter und Verkehrssituation passen.',
        ],
        gallery: [
      ...
      },
      {
        ...
        body:
          'Gäste können Manfredi und die Familie für praktische Hinweise kontaktieren, besonders zu Wanderungen, familienfreundlichen Plänen und längeren Reisen.',
